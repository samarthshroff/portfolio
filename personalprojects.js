        ...
        },
        {
            ...
            description: `
                ...
                <ul>
                    ...
                    <li>
                        <strong>Climb Dash Mechanic:</strong>
                    ...
                    <li>
                        <strong>Dynamic Vault Trace Configuration:</strong>
                    ...
                    <li>
                        <strong>Component Accessors:</strong>
                    ...
                    <li>
                        <strong>Floor Detection and Climb Termination:</strong>
                ...
                <ul>
                    ...
                    <li>
                        <strong>Dynamic Climb Trace Length:</strong>
